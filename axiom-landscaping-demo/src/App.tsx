...
const imagery = {
  hero:
    'https://images.pexels.com/photos/17240696/pexels-photo-17240696.jpeg?auto=compress&cs=tinysrgb&w=1900&h=1260&fit=crop',
  featured:
    'https://images.pexels.com/photos/34037980/pexels-photo-34037980.jpeg?auto=compress&cs=tinysrgb&w=1500&h=1100&fit=crop',
  curbAppeal:
    'https://images.pexels.com/photos/30196217/pexels-photo-30196217.jpeg?auto=compress&cs=tinysrgb&w=1300&h=980&fit=crop',
  afterDark:
    'https://images.pexels.com/photos/35828688/pexels-photo-35828688.jpeg?auto=compress&cs=tinysrgb&w=1300&h=980&fit=crop',
...
const services = [
  {
    ...
    copy: 'Dining terraces, lounge zones, and grade transitions planned around movement and daily use.',
    detail: 'Circulation and gathering',
  },
  {
    number: '02',
    title: 'Front approaches and curb appeal',
    copy: 'Walkways, steps, and planting that make the home read cleanly from the street.',
    detail: 'Arrival sequence and first impression',
  },
  {
    number: '03',
    title: 'Planting and softscape',
    copy: 'Layered planting, privacy screening, and structure that still reads well in three years.',
    detail: 'Seasonality and long-term structure',
  },
  {
    number: '04',
    title: 'Landscape lighting and finishing details',
    copy: 'Low-voltage lighting, edges, and finish work that keeps the property legible after dark.',
    detail: 'Evening presence and polish',
  },
];
...
const processSteps = [
  {
    title: 'Site review',
    copy: 'We look at access, drainage, sun exposure, and the spots where the property feels unfinished.',
  },
  {
  ...
  },
  {
    ...
    copy: 'We install, refine, plant, and light the space so it reads as one composition.',
  },
];
...
const Hero = () => (
  <section className="relative overflow-hidden px-4 pb-16 pt-10 sm:pb-20 sm:pt-14 lg:pb-24 lg:pt-16">
    ...
    <div className="mx-auto grid max-w-7xl items-end gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
      <div className="relative z-10 max-w-2xl">
        <p className={`${labelClass} animate-rise-in`}>Residential outdoor architecture</p>
    ...
    <div className="mx-auto max-w-7xl">
      <div className="grid gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:gap-16">
        <div className="max-w-xl">
          <SectionHeading
            label="Scope"
            title="Work that changes how the property reads."
            body="We focus on entry sequences, outdoor rooms, and finish layers that make the yard feel intentional, not patched."
          />
    ...
    <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
      <div className="max-w-xl">
        <SectionHeading
          ...
          title="Proof should read in a single glance."
          body="The finished yard should feel composed from every angle: approach, gathering space, planting, and light."
        />
      ...
      <div>
        <div className="grid gap-5 sm:grid-cols-2">
          <figure className="relative overflow-hidden rounded-[30px] bg-surface-card/40 shadow-[0_24px_70px_rgba(0,0,0,0.4)] ring-1 ring-white/10">
            <img
              src={imagery.before}
              alt="Backyard before landscaping buildout and patio installation"
              className="h-[clamp(18rem,34vw,31rem)] w-full object-cover object-center grayscale brightness-[0.55] contrast-[0.88] saturate-0"
              loading="lazy"
            />
            ...
            <figcaption className="absolute inset-x-5 bottom-5">
              ...
              <p className="mt-2 text-[15px] leading-7 text-white/90">
                Open yard with no clear structure or finish.
              </p>
            </figcaption>
          </figure>
          ...
          <figure className="relative overflow-hidden rounded-[30px] bg-surface-card/40 shadow-[0_24px_70px_rgba(0,0,0,0.4)] ring-1 ring-white/10">
            <img
              ...
              className="h-[clamp(18rem,34vw,31rem)] w-full object-cover object-center"
              loading="lazy"
            />
            ...
            <figcaption className="absolute inset-x-5 bottom-5">
              ...
              <p className="mt-2 text-[15px] leading-7 text-white/90">
                A cleaner outdoor room with more definition and evening presence.
              </p>
            </figcaption>
          </figure>
        </div>
...
const Projects = () => (
  <section id="projects" className="scroll-mt-28 px-4 py-20 sm:py-28">
    <div className="mx-auto max-w-7xl">
      <SectionHeading
        label="Selected work"
        title="Projects that show the finish, not just the task list."
        body="We present work the way homeowners experience it: how the approach reads, how the yard functions, and how it feels after dark."
      />
        ...
        <article className="group relative overflow-hidden rounded-[34px] bg-surface-card/20 shadow-[0_28px_80px_rgba(0,0,0,0.45)] ring-1 ring-white/10">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8">
            ...
            <p className="mt-4 max-w-xl text-[16px] leading-7 text-stone-200/90">
              ...
              quieter, clearer, and easier to use after dark.
            </p>
              ...
              <figure key={item.title} className="group">
                <div className="overflow-hidden rounded-[26px] ring-1 ring-white/10">
                  <img
                    src={item.image}
                    alt={item.alt}
                    className="h-64 w-full object-cover object-center transition-transform duration-700 group-hover:scale-[1.02]"
                    loading="lazy"
                  />
                </div>
  ...
  <section id="coverage" className="scroll-mt-28 px-4 py-20 sm:py-28">
    <div className="mx-auto max-w-7xl border-y border-white/8 py-20">
      ...
      <SectionHeading
        ...
        body="Site visits are scheduled by appointment. If you are slightly outside the core area, ask anyway."
      />
  ...
  <section className="px-4 py-20 sm:py-28">
    <div className="mx-auto max-w-7xl border-y border-white/8 py-20">
      ...
      <SectionHeading
        ...
        title="We check the details that make the estimate honest."
              ...
              >
                ...
                <label className="mt-4 flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    placeholder="Tell us what you want to change, what the yard needs, and your ideal timing."
                  />
                </label>
