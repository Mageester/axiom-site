    ...
    return (
        <div className="pt-32 pb-24 px-6">
            ...
            <div className="max-w-[800px] mx-auto text-secondary leading-relaxed">
                <h1 className="text-[40px] font-semibold text-primary mb-8 tracking-tight">Privacy Policy</h1>
                <p className="mb-6">Last Updated: {new Date().toLocaleDateString('en-CA')}</p>

                <h2 className="text-[20px] font-semibold text-primary mb-4 mt-12">1. Information Collection</h2>
                ...
                <h2 className="text-[20px] font-semibold text-primary mb-4 mt-8">2. Use of Data</h2>
                ...
                <h2 className="text-[20px] font-semibold text-primary mb-4 mt-8">3. Transfer Of Data</h2>
                ...
                <h2 className="text-[20px] font-semibold text-primary mb-4 mt-8">4. Security Of Data</h2>
                ...
                <h2 className="text-[20px] font-semibold text-primary mb-4 mt-8">5. Analytics</h2>
