  ...
  return (
    <>
      <SEO
        ...
        description="A concise delivery method for qualification, architecture, production, QA, and controlled release."
      />
      <Layout>
        <main className="mx-auto w-full max-w-7xl px-6 py-20 md:px-8 md:py-28">
          <section className="grid gap-6 md:grid-cols-12">
            <article className="md:col-span-8 rounded-2xl border border-white/10 bg-[#0d1323]/60 p-8 shadow-[inset_0_1px_2px_rgba(255,255,255,0.1)] backdrop-blur-xl md:p-12">
              <p className="font-axiomMono text-xs uppercase tracking-[0.1em] text-axiom-text-mute">Method</p>
              <h1 className="mt-4 text-[clamp(2.25rem,4vw,3.5rem)] font-extrabold tracking-tight text-axiom-text-main">
                Engagement Method
              </h1>
              <p className="mt-4 max-w-2xl text-slate-300">Each engagement runs through a fixed sequence from fit review to controlled launch.</p>
            ...
            <article className="md:col-span-4 rounded-2xl border border-white/10 bg-[#0d1323]/60 p-8 shadow-[inset_0_1px_2px_rgba(255,255,255,0.1)] backdrop-blur-xl">
              <p className="font-axiomMono text-xs uppercase tracking-[0.1em] text-axiom-text-mute">Delivery Rules</p>
              <p className="mt-4 text-xl font-semibold text-axiom-text-main">Scope Before Build</p>
              <p className="mt-3 text-sm text-slate-300">Structure and conversion priorities are locked before production begins.</p>
            </article>
          </section>
        </main>
        <Footer />
