...
const standardsCards = [
  {
    ...
    detail:
      'We keep the build light so it loads quickly and responds cleanly on mobile and desktop.',
  ...
  {
    title: 'Clear on small screens',
    detail:
      'Layouts stay readable and easy to use when the phone is the only screen that matters.',
  ...
  },
  {
    ...
    detail:
      'Forms, routes, and critical actions are tested before anything goes live.',
    desktopSpan: 'lg:col-span-4',
    icon: (
      <svg aria-hidden="true" className="h-5 w-5" fill="none" viewBox="0 0 24 24">
...
const Home: React.FC = () => {
  return (
    <>
      <SEO
        title="Axiom | Premium Websites for Established Businesses"
          ...
          <section data-hero-root className="pt-12 md:pt-20">
            <div className="max-w-5xl">
              <div>
                ...
                <div
                  data-startup-meta
                  className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 text-[10px] uppercase tracking-[0.14em] text-slate-300"
                >
                  <span>30-minute Zoom consultation</span>
          ...
          <RevealBlock as="section" className="pt-20 md:pt-24">
            <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
              <div className="lg:col-span-4">
                <p className="font-axiomMono text-[11px] uppercase tracking-[0.2em] text-[#A7B3BC]">Delivery process</p>
                <h2 className="mt-3 max-w-[20ch] text-2xl font-bold tracking-tight text-[#F2F4F7] md:text-4xl">
                  A clear path from consultation to launch.
                </h2>
          ...
          <RevealBlock as="section" className="pt-16 md:pt-28" variant="feature">
            <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(12,18,33,0.94)_0%,rgba(10,15,26,0.97)_100%)] px-6 py-12 shadow-[0_22px_70px_rgba(0,0,0,0.24)] md:px-8 md:py-14 lg:px-10 lg:py-16">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-5 lg:grid-cols-12">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/12 bg-gradient-to-br from-[#0f1628]/88 via-[#101726]/82 to-[#0b1120]/88 p-8 text-center shadow-[0_22px_60px_rgba(0,0,0,0.35)] md:p-12">
              ...
              <div className="relative z-10">
                ...
                <div className="mx-auto mt-6 flex max-w-2xl flex-wrap items-center justify-center gap-x-5 gap-y-2">
                  ...
                  <span className="hidden h-1 w-1 rounded-full bg-white/35 md:inline-block" />
                  <span className="font-axiomMono text-[10px] uppercase tracking-[0.14em] text-slate-300">Scope discussed before quote</span>
                </div>
              </div>
            </div>
          </RevealBlock>
