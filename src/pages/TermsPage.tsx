    ...
    return (
        <div className="pt-32 pb-24 px-6">
            <SEO
                ...
                description="Terms and conditions for Axiom web and digital services."
            />
            <div className="max-w-[800px] mx-auto text-axiom-text-mute leading-relaxed">
                ...
                <h2 className="text-[20px] font-semibold text-axiom-text-main mb-4 mt-12">1. Agreement to Terms</h2>
                ...
                <h2 className="text-[20px] font-semibold text-axiom-text-main mb-4 mt-8">5. Governing Law</h2>
                ...
                <h2 className="text-[20px] font-semibold text-axiom-text-main mb-4 mt-8">6. Changes</h2>
