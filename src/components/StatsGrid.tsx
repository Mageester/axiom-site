      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div ref={oneReveal.ref} className={revealClass(oneReveal.isVisible)} style={{ transitionDelay: '0ms' }}>
          <article className={`${cardClass} flex flex-col space-y-4`}>
            <p className="font-axiomMono text-[11px] uppercase tracking-[0.1em] text-[#A7B3BC]">Delivery Standard</p>
            <h3 className="text-3xl font-black tracking-tight text-[#F2F4F7] md:text-4xl">Clear Positioning</h3>
            <p className="text-sm leading-[1.7] text-slate-300">Messaging and page hierarchy are clarified before production starts.</p>
        ...
        <div ref={twoReveal.ref} className={revealClass(twoReveal.isVisible)} style={{ transitionDelay: '100ms' }}>
          <article className={`${cardClass} flex flex-col space-y-4`}>
            <p className="font-axiomMono text-[11px] uppercase tracking-[0.1em] text-[#A7B3BC]">Delivery Standard</p>
            <h3 className="text-3xl font-black tracking-tight text-[#F2F4F7] md:text-4xl">Reliable Interaction Paths</h3>
            <p className="text-sm leading-[1.7] text-slate-300">Forms, links, and key pages are checked across major breakpoints before launch.</p>
        ...
        <div ref={threeReveal.ref} className={revealClass(threeReveal.isVisible)} style={{ transitionDelay: '200ms' }}>
          <article className={`${cardClass} flex flex-col space-y-4`}>
            <p className="font-axiomMono text-[11px] uppercase tracking-[0.1em] text-[#A7B3BC]">Delivery Standard</p>
            <h3 className="text-3xl font-black tracking-tight text-[#F2F4F7] md:text-4xl">Practical Launch Discipline</h3>
            <p className="text-sm leading-[1.7] text-slate-300">The site is checked for clarity, speed, and handoff readiness before release.</p>
