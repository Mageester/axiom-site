        ...
        <div ref={oneReveal.ref} className={revealClass(oneReveal.isVisible)} style={{ transitionDelay: '0ms' }}>
          <article className={cardClass}>
            ...
            <svg viewBox="0 0 260 70" className="mt-6 w-full" role="img" aria-label="Decorative amber bar chart">
              ...
              <rect x="44" y="22" width="24" height="40" rx="4" fill="#B05D41" opacity="0.55" />
              <rect x="80" y="12" width="24" height="50" rx="4" fill="#B05D41" opacity="0.7" />
              <rect x="116" y="26" width="24" height="36" rx="4" fill="#B05D41" opacity="0.6" />
              <rect x="152" y="8" width="24" height="54" rx="4" fill="#B05D41" opacity="0.78" />
              <rect x="188" y="18" width="24" height="44" rx="4" fill="#B05D41" opacity="0.65" />
              <rect x="224" y="4" width="24" height="58" rx="4" fill="#B05D41" opacity="0.86" />
            </svg>
          </article>
        </div>
