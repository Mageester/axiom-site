                            ...
                            <CardContent className="p-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => window.location.href = `/api/omniscient/leads/export?tier=S,A,B&format=xlsx`}
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={() => window.location.href = `/api/omniscient/leads/export?tier=S,A,B&format=csv`}
                                    >
