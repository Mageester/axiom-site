...
} from "@omni/lib/ui/storage";
import { getTierConfig } from "@omni/lib/ui/tokens";

import { DossierSkeleton } from "@omni/components/dossier/dossier-skeleton";
import { IdentityCard } from "@omni/components/dossier/identity-card";
import { QuickActions } from "@omni/components/dossier/quick-actions";
import { ContactQuality } from "@omni/components/dossier/contact-quality";
import { PainSignalsPanel } from "@omni/components/dossier/pain-signals-panel";
import { WebsiteAssessmentPanel } from "@omni/components/dossier/website-assessment-panel";
import { DisqualifiersPanel } from "@omni/components/dossier/disqualifiers-panel";
import { CallSheet } from "@omni/components/dossier/call-sheet";
import { OperationalHistory } from "@omni/components/dossier/operational-history";
...
export function DossierClient({ leadId }: { leadId: number }) {
    ...
    useEffect(() => {
        setLoading(true);
        setError(null);
        fetch(`/api/omniscient/leads/${leadId}`)
            .then(res => {
