...
export default function DashboardClient() {
    ...
    useEffect(() => {
        fetch("/api/omniscient/leads/analytics")
            .then(r => r.json())
                                ...
                                {data.recentActivity.map((lead, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2 shrink-0">
                                            ...
                                            {lead.axiomScore !== null && <ScoreTier score={lead.axiomScore} />}
                                        </div>
                                    </div>
                                ))}
                            </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2 shrink-0">
                                            ...
                                            {lead.axiomScore !== null && (
                                                <span className="text-xs font-bold font-mono text-emerald-400">{lead.axiomScore}</span>
                                            )}
                                        </div>
                                    </div>
                                ))}
