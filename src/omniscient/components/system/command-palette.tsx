...
export function CommandPalette({ open, onClose, onOpenShortcuts }: CommandPaletteProps) {
            ...
            case "navigate-filter":
                {
                    ...
                    navigate(`${cmd.action.path}?${params.toString()}`);
                }
                break;
            case "export":
                {
                    ...
                    window.open(`/api/omniscient/leads/export?${exportParams.toString()}`, "_blank");
                }
                break;
            case "modal":
    ...
    }, [navigate, onClose, onOpenShortcuts, togglePerf]);
