...
import { type QueueItem } from '@omni/components/hunt/queue-summary';
import { type LogEntry } from '@omni/components/hunt/terminal-panel';
        ...
        for (let jobIdx = 0; jobIdx < pendingJobs.length; jobIdx++) {
            ...
            try {
                await new Promise<void>((resolve, reject) => {
                    ...
                    const eventSource = new EventSource(`/api/omniscient/scrape?${params.toString()}`);
